    ...
    <section id="home" className="hero">
      <div className="container hero-container" style={{ justifyContent: 'center', textAlign: 'center' }}>
        <div className="hero-content" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <h1 className="hero-title" style={{ fontSize: '5rem', marginBottom: '0.5rem', fontStyle: 'italic', fontWeight: 'bold', color: 'var(--accent-neon)' }}>
            Ravi Kumar D
          </h1>
          <p className="hero-subtitle" style={{ fontSize: '1.5rem', color: 'var(--accent-neon)', fontWeight: 'bold' }}>
          ...
          <div className="hero-actions" style={{ marginTop: '2.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem' }}>
              <a href="https://github.com/D-RaviKumarofficial" target="_blank" rel="noreferrer" className="icon-btn" title="GitHub">
              ...
              <a href="https://www.linkedin.com/in/ravi-kumar-d-535a98267" target="_blank" rel="noreferrer" className="icon-btn" title="LinkedIn">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
